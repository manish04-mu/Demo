...
{
  char test_string1[MAX_STR_LEN] = "This has only $ as delimiter";
  char test_string2[MAX_STR_LEN] = "This has only ; as delimiter";
  char test_string3[MAX_STR_LEN] = "This has no delimiters";
...
{
  char test_string1[MAX_STR_LEN] = "Junk$Welcome to LTTS;remove";
  char test_string2[MAX_STR_LEN] = "Hi$This is $$an example #2 string;And filled with words";
  char test_string3[MAX_STR_LEN] = "Function to read from file and $use the read data; as a string";
  char ouput_string1[MAX_STR_LEN];
  char ouput_string2[MAX_STR_LEN];
  char ouput_string3[MAX_STR_LEN];
