...
/*
  ...
  int* iptr  ->  Equal to address bus width (machine bit size) 4bytes, (64 bit) 8 bytes
  float* fptr -> Equal to address bus width (machine bit size) 4bytes, (64 bit) 8 bytes
  char* cptr  -> Equal to address bus width (machine bit size) 4bytes, (64 bit) 8 bytes
  void* ptr   -> Equal to address bus width (machine bit size) 4bytes, (64 bit) 8 bytes
